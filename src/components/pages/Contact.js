...
import Lloyd from '../images/sai2.png';
        ...
        <section className="content-section text-white text-center" id="services">
          <div className="container">
            <div className="content-section-heading">
              ...
              <h1 className="mb-5" style={{ color: "white" }}>Creator and Founder of DONATION FUND ...</h1>
            </div>
            <div className="row">
              ...
              <div className="col-lg-2 col-md-6 mb-5 mb-lg-0">
                <span className="service-icon rounded-circle mx-auto mb-3">
                  <a href="https://sites.google.com/view/saireddy02" target="blank_"> <img src={Lloyd} style={{ width: "150px", height: "150px" }} alt="Lloyd Marcelino" id="contact_photo"></img></a>
                </span>
                <h4>
                  <strong>Sai Srinivasa Reddy</strong>
                </h4>
                <p className="text-faded mb-0" style={{ color: "white" }}>Software Developer/ Security Analyst</p>
                <p className="text-faded mb-0" style={{ color: "white" }}>University of KL</p>
              </div>
              ...
              render={({ handleChange, handleBlur, values, errors, handleSubmit, touched }) => (
                <Fragment>
                  ...
                  <Form className="site-form" onSubmit={handleSubmit}>
                    ...
                    <Button className="site-form__action" type="submit"  disabled={isSending}>
                      {
